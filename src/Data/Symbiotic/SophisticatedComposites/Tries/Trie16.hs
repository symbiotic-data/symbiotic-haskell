...
module Data.Symbiotic.SophisticatedComposites.Tries.Trie16 where

import Data.Symbiotic.SophisticatedComposites.Tries.Trie16.Orphans ()
...
instance (FromJSON k, FromJSON a, Ord k) => FromJSON (Trie16 k a) where
  parseJSON json = Trie16 <$> trie json
    where
